        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(  
                                                 ...
                                                 caption=f'<b>Hey, {u.mention} 👋🏻\nWelcome To Our Group {message.chat.title}\n\nYou Can Find Movies / Series / Animes etc. From Here. Enjoy 😉.\n\n<b>┏≫ ғᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇs</b>\n┣ <b>ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ›› <a href=https://youtube.com/channel/UC5atLoFND7z0YnBEXzLn6EA>FC Telugu</a></b></code>\n<b>┗≫ ғᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇs</b>\n\nനിങ്ങൾക്ക് ഇവിടെ നിന്ന് സിനിമകൾ / സീരീസ് / ആനിമുകൾ മുതലായവ ലഭിക്കുന്നത് ആണ്..\n\n© <a href=https://t.me/Xdiskpk><b>Farooq</b></a></b>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔰 ɢʀᴏᴜᴘ ʀᴜʟᴇs 🔰', url='https://t.me/fq_download_issues/20') ] ] )
                )
